...
<header class="container header">
    ...
    <?php if(plsh_gs('use_image_logo') == 'on') {
		if(is_ssl()) {
			$logo_img_url = str_replace("http:", "https:", plsh_gs('logo_image'));
		} else {
			$logo_img_url = plsh_gs('logo_image');
		} ?>
        <div class="logo-image">
            <a href="<?php echo home_url('/'); ?>"><img src="<?php echo esc_url($logo_img_url); ?>" alt="<?php esc_attr(plsh_gs('logo_image_alt')); ?>"></a>
        </div>
    <?php } else { ?>
        <div class="logo-text">
