...
$default = plsh_gs('background_repeat');
$mod = get_theme_mod('background_repeat', $default);
if ( ! empty( $mod ) && $mod == 'repeat') 
{
    echo 'body { background-size: auto; }';
}
...
generate_css('.navbar-wrapper-responsive .dropdown-menu.full-width ', 'background', 'menu_dropdown_background', '#' );
