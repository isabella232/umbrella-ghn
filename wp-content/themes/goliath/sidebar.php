<!-- Sidebar -->
<div class="main-sidebar <?php if(plsh_gs('sidebar_position') === 'left' && (is_singular(array('post', 'page')) || is_home() || is_search() || is_category() || is_tag())) { echo ' left'; } else { echo 'right'; } ?>">
